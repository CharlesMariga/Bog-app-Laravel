...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        ...
        <footer id="newsletter"
            class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16 mx-6">
            ...
            <div class="mt-10 flex flex-col items-center space-y-4">
                <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full">
                    ...
                    <form method="POST" action="newsletter" class="lg:flex text-sm" autocomplete="off">
                        @csrf
